        ...
        <div className="content">
          ...
          <div className="container panel">
            <div className="row">
              ...
              <div className="col">
                <img
                  className="img tertiary-image"
                  src={require("../images/zimbabwe.png")}
                  alt="02"
                />
                <img
                  className="img tertiary-image"
                  src={require("../images/Uganda.png")}
                  alt="03"
                />
              </div>
              <div className="col">
              ...
              <div className="col">
                <img
                  className="img tertiary-image"
                  src={require("../images/Nigeria.png")}
                  alt="05"
                />
                <img
                  className="img tertiary-image"
                  src={require("../images/Niger.png")}
                  alt="06"
                />
              </div>
              <div className="col">
